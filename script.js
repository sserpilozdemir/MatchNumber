const images = [
    ...
    {
      image_name: 'birtday candles.jpg',
      number_of_items: 6,
    },
    {
    ...
    {
      image_name: 'hot air balloon.jpg',
      number_of_items: 5,
    },
    {
...
const generatePlusOrMinus = () => {
    ...
    return number0to1 ===0  ? -1 : +1; //this "if style" is the best !!!! :)

};

const setImageName = (randomImageName) => {

const imageName = randomImageName.slice(0, randomImageName.lenght -4);
...
const generate  = ()  => {
    ...
    chosen = false;
    const randomNumber = Math.floor(Math.random() * images.lenght);
